...
local data =  {
    ...
    outpost = {key = "outpost", name = "Plainsman Outpost", tile = "city", allowedTiles = {"grass"}, cost = 3, hp = 5, maxHp = 5, align = true},
    ...
    sylvan_glade = {key = "sylvan_glade", name = "Sylvan Glade", tile = "city", allowedTiles = {"forest"}, cost = 3, hp = 5, maxHp = 5, align = true},
    warglade = {key = "warglade", name = "War Glade", tile = "city", allowedTiles = {"forest"}, cost = 3, hp = 5, maxHp = 5, align = true},
    dwarf_fortress = {key = "dwarf_fortress", name = "Dwarven Fortress", tile = "city", allowedTiles = {"mountain"}, cost = 3, hp = 10, maxHp = 10, align = true},
